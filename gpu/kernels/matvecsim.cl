// OpenCL port de gpu/shaders/matvecsim.comp (E3, specs/ENGINE_V2.md §3.2) — mesma aritmetica inteira, bit-exata.
__kernel void matvecsim(__global const int* restrict w, __global const long* restrict x, __global long* restrict y, int m, int k, int divId, long divv) {
