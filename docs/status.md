...
**Milestone corrente:** Estabilização anti-N10 (partes 57/67) → depois M7 — Kof Brain
**Milestones:** M0 ✅ · M1 ✅ · M2–M5 🟡 · **M6 🟡 Parcial (implementada; PENDENTE-N10)**
...
| Próxima ação | playbook anti-N10 nas partes 45/47/57/67 → colher testes+benchmarks M3–M6 |
