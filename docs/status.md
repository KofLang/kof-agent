...
7. **M34 FASE B — transformer forward 100% Kof**: ligar 161 (GGUF+dequant) ao GraphExecutor (embed→rmsnorm→attn+RoPE+KV→SwiGLU→lmhead) sobre tensorMatMul/gpu.dispatchMatmul; comparar dequant com ggml dequantize_row_q4_K de referência; descartar 160_llm_subprocess.kf
